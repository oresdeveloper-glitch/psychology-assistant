...
s, d = get("/predictions/user_001?limit=5")
if s == 200: ok += 1; print("5. History: OK (%d predictions)" % len(d))
else: fail += 1; print("5. History: FAIL", s, d)

# 6. Sensor history
s, d = get("/sensor-readings/user_001?limit=5")
if s == 200: ok += 1; print("6. Sensor history: OK (%d readings)" % len(d))
else: fail += 1; print("6. Sensor history: FAIL", s, d)
